      ...
      <div className="h-16 w-screen bg-toolbar flex items-center justify-around">
        ...
        <div className="flex space-x-7 ml-7">
          <form className="relative flex">
            <input id="url-input" className="h-10 w-96 bg-white rounded-full flex items-center px-4 justify-between placeholder:text-gray-600 placeholder:font-light placeholder:font-sans" placeholder="New Tab">
            </input>
