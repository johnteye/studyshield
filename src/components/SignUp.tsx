  ...
  return (
    ...
    <div className="logo flex flex-row absolute top-7 left-8">
      ...
      <div className="card h-4/5 w-2/5 bg-white shadow-2xl rounded-3xl flex flex-col items-center justify-center">
        ...
        <div className="login h-14 w-3/4 bg-card-blue rounded-full flex items-center justify-between">
          <p className="font-sans ml-20">
        ...
        <div className="details w-3/4 rounded-3xl h-96 bg-card-blue mt-10 flex flex-col justify-center items-center">
          <h1 className="font-sans font-semibold text-xl mb-2 text-custom-gray mr-72">
            Email
          </h1>
          <input className="h-12 rounded-full w-5/6" type="text" />
          <h1 className="font-sans font-semibold text-xl mb-2 text-custom-gray mr-60 mt-5">
            Password
          </h1>
          <input className="h-12 rounded-full w-5/6 mb-5" type="text" />
          <h1 className="font-sans font-semibold text-xl mb-2 text-custom-gray mr-44 mt-5">
            Confirm Password
          </h1>
          <input className="h-12 rounded-full w-5/6 mb-5" type="text" />
        </div>
